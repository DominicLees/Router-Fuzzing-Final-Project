...
- Developing a Python tool that rehosted the firmware binaries using Unicorn
...
- - - **example_targets** - contains short C programs with intentionally included vulnerabiltites to test if the fuzzer is able to find them, also includes the compiled MIPS32 binaries of those programs
